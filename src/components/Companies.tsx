                    ...
                    {projects.length === 0 ? (
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {projects.map((projectAddress, index) => (
                                <div key={projectAddress} className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-5 hover:shadow-md transition-shadow duration-200">
                                    <div className="mb-4">
                                        <div className="flex items-center justify-between mb-2">
                                            <span className="text-2xl">🌲</span>
                                            <span className="text-xs bg-green-200 text-green-800 px-2 py-1 rounded-full font-medium">Active</span>
                                        </div>
